...
<asp:Content ID="formContent" ContentPlaceHolderID="contentPlaceHolder" runat="Server">
    <div class="panel" style="padding: 15px; width: 1140px; font-weight: bold; height: 390px;">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eRecruitmentConnectionString %>" SelectCommand="SELECT * FROM [skill]"></asp:SqlDataSource>
        <br />
        <br />
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="jobid" DataSourceID="SqlDataSource2">
            <AlternatingItemTemplate>
                ...
                <asp:Label ID="dateuploadedLabel" runat="server" Text='<%# Eval("dateuploaded") %>' />
                    <br />
                    skilltxt1:
                <asp:Label ID="skilltxt1Label" runat="server" Text='<%# Eval("skill1") %>' />
                    <br />
                    skilltxt2:
                <asp:Label ID="skilltxt2Label" runat="server" Text='<%# Eval("skill2") %>' />
                    <br />
                    jobtxt:
            ...
            <EditItemTemplate>
                ...
                <asp:TextBox ID="dateuploadedTextBox" runat="server" Text='<%# Bind("dateuploaded") %>' />
                    <br />
                    skilltxt1:
                <asp:TextBox ID="skilltxt1TextBox" runat="server" Text='<%# Bind("skill1") %>' />
                    <br />
                    skilltxt2:
                <asp:TextBox ID="skilltxt2TextBox" runat="server" Text='<%# Bind("skill2") %>' />
                    <br />
                    jobtxt:
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:eRecruitmentConnectionString %>" SelectCommand="SELECT * FROM [jobs] WHERE ([skilltxt1] = @skilltxt1)">
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList1" Name="skilltxt1" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
            <InsertParameters>
                <asp:Parameter Name="skilltxt1" Type="String" />
            </InsertParameters>
        </asp:SqlDataSource>
        <br /><br /><br />
    </div>
