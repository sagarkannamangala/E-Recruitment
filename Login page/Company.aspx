    ...
    <div>
        <div style="margin-top: 30px; height: 208px;">
            <div class="panel" style="padding:10px; width:920px;">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eRecruitmentConnectionString %>" SelectCommand="SELECT [firstname], [lastname], [education], [university] FROM [candidate]"></asp:SqlDataSource>
        ...
        <div class="panel panel-info" style="float: right; margin-top: -214px; width: 210px; padding: 10px;">
           ...
           <%-- <asp:DataList ID="DataList1" runat="server" CellSpacing="2" DataSourceID="SqlDataSource2" RepeatLayout="Flow">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:eRecruitmentConnectionString %>" SelectCommand="SELECT [companyname], [reviews] FROM [reviews]"></asp:SqlDataSource>--%>
        </div>
    </div>
</asp:Content>
